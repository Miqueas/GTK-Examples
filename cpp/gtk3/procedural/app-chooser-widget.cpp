...
static void on_button_toggled(
  Gtk::ToggleButton* self,
  AppChooserWidgetSetting setting,
  std::vector<Gtk::Widget*> widgets
);

static const Glib::ustring APP_ID = "io.github.Miqueas.GTK-Examples.C.Gtk3.Procedural.AppChooserWidget";
...
static void on_app_startup(Glib::RefPtr<Gtk::Application> self) {
  ...
  show_all_toggle->signal_toggled().connect(
    sigc::bind<Gtk::ToggleButton*, AppChooserWidgetSetting, std::vector<Gtk::Widget*>>(
      sigc::ptr_fun(&on_button_toggled),
      show_all_toggle,
      AppChooserWidgetSetting::SHOW_ALL,
      widgets
    )
  );
  ...
  show_default_toggle->signal_toggled().connect(
    sigc::bind<Gtk::ToggleButton*, AppChooserWidgetSetting, std::vector<Gtk::Widget*>>(
      sigc::ptr_fun(&on_button_toggled),
      show_default_toggle,
      AppChooserWidgetSetting::SHOW_DEFAULT,
      widgets
    )
  );
  ...
  show_fallback_toggle->signal_toggled().connect(
    sigc::bind<Gtk::ToggleButton*, AppChooserWidgetSetting, std::vector<Gtk::Widget*>>(
      sigc::ptr_fun(&on_button_toggled),
      show_fallback_toggle,
      AppChooserWidgetSetting::SHOW_FALLBACK,
      widgets
    )
  );
  ...
  show_other_toggle->signal_toggled().connect(
    sigc::bind<Gtk::ToggleButton*, AppChooserWidgetSetting, std::vector<Gtk::Widget*>>(
      sigc::ptr_fun(&on_button_toggled),
      show_other_toggle,
      AppChooserWidgetSetting::SHOW_OTHER,
      widgets
    )
  );
  ...
  show_recommended_toggle->signal_toggled().connect(
    sigc::bind<Gtk::ToggleButton*, AppChooserWidgetSetting, std::vector<Gtk::Widget*>>(
      sigc::ptr_fun(&on_button_toggled),
      show_recommended_toggle,
      AppChooserWidgetSetting::SHOW_RECOMMENDED,
      widgets
    )
  );
}
...
static void on_button_toggled(
  ...
  switch (setting) {
    case AppChooserWidgetSetting::SHOW_ALL:
