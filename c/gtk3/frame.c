...
const static gchar* APP_ID = "io.github.Miqueas.GTK-Examples.C.Gtk3.Frame";
const static gchar* APP_TITLE = "GtkFrame";
...
static void on_app_startup(GApplication* self, gpointer data) {
  ...
  g_signal_connect(button, "clicked", G_CALLBACK(on_button_clicked), frame);
}
