...
const gchar *APP_ID = "io.github.Miqueas.GTK-Examples.C.Gtk3.Revealer";
const gchar *APP_TITLE = "GtkRevealer";
...
void onAppStartup(GApplication *self, gpointer data) {
  ...
  g_signal_connect(button, "clicked", G_CALLBACK(onClicked), revealer);
