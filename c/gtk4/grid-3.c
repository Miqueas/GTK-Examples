...
const gchar *APP_ID = "io.github.Miqueas.GTK-Examples.C.Gtk3.Grid3";
const gchar *APP_TITLE = "GtkGrid";
...
void onAppStartup(GApplication *self, gpointer data) {
  ...
  gtk_grid_attach(GTK_GRID(grid), gtk_label_new("Columns"), 1, 0, 2, 1);
  gtk_grid_attach(GTK_GRID(grid), gtk_label_new("Rows"), 0, 0, 1, 3);
