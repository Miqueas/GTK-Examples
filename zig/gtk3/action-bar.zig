...
const APP_ID = "io.github.Miqueas.GTK-Examples.Zig.Gtk3.ActionBar";
...
fn onStartup(app: *gtk.Application, _: ?*anyopaque) callconv(.c) void {
    ...
    box.packStart(box_label.as(gtk.Widget), gtk.@"true"(), gtk.@"true"(), 0);
    box.packEnd(action_bar.as(gtk.Widget), gtk.@"false"(), gtk.@"true"(), 0);
